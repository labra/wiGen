...
do
outName="outOrgsNR"
params="--countries 1 --dataSets 1 --slices 1 --observations 1 --computations 1 --Indicators 1 --Organizations $value --shex schemas/webindex_NonRecursive.shex --allTypes --time"
