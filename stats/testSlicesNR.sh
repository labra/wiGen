...
do
outName="outSlicesNR"
params="--countries 1 --dataSets 1 --slices $value --observations 1 --computations 1 --Indicators 1 --Organizations 1 --shex schemas/webindex_NonRecursive.shex --allTypes --time"
